...
class VDIServer(models.Model):
    ...
    server_name = models.CharField(blank=True,unique=True, max_length=255,verbose_name="اسم سرور")
...
class UserProfile(models.Model):
    ...
    owner_password = models.CharField(blank=False, max_length=100,verbose_name="پسورد")
    owner_ip = models.CharField(blank=False,default='1.1.1.1',unique=True, max_length=100,verbose_name="آیپی کانتینر",validators=[validate_ipv4_address])
    owner_browser_ip = models.CharField(blank=False,default='1.1.1.1',unique=True, max_length=100,verbose_name="آیپی فایل منیجر",validators=[validate_ipv4_address])
    ...
    owner_server = models.ForeignKey('VDIServer',on_delete=models.DO_NOTHING,verbose_name="سرور")
...
class VirtualDesktop(models.Model):
    ...
    vd_revoked_at = models.DateTimeField(blank=True,auto_now_add=True, verbose_name="تاریخ ابطال")
