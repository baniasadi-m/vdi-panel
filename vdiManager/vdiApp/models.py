...
class UserProfile(models.Model):
    ...
    owner_is_active = models.BooleanField(blank=False, default=True, verbose_name='فعال بودن کاربری')
...
class VirtualDesktop(models.Model):
    ...
    vd_owner = models.ForeignKey('UserProfile',on_delete=models.DO_NOTHING,verbose_name="تحویل گیرنده")
