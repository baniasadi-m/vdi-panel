                ...
                if Active_Directory_Enabled == False:
                    ...
                    #### Profile is active
                        ...
                        if owner_vd != None:
                            ...
                            #                 # owner.owner_updated_at = datetime.now()
                            #                 owner.save() 
                            ...
                            #                                                         )
                            #                 vdi_name=f"{vdi_name}"
                            #                 vdi_url=f"{server.server_scheme}://{server.server_ip}/{username}"
                            #                 vdi_vncpass=f"{vnc_pass}"
                            #                 vdi_browser_url=f"{server.server_scheme}://{server.server_ip}/{username}/browser"
                            #                 vdi_browser_user='admin'
                            #                 vdi_browser_pass='admin'
